 ...
 if (!(isfuncdef techFindLayer)) {
    ...
    #
    T = (buildTechnology SmicSP10R_cal018_epm_sali_p2mt6_18335155_Cmin unconditional "ff" "2d" "mcs2d" "ph")
    techSetIndie T "ON"
...
techAddLayer T ( buildLayer                metal4  0.4320    C   0.0000  0 )
...
techAddLayer T ( buildLayer                    V4  1.0310    V   0.0000  0 )
...
techAddLayer T ( buildLayer           metal4_diel  1.0310    D   4.2000  0 )

techAddLayer T ( buildLayer               metal5a  0.4320    C   0.0000  0 )
...
techAddLayer T ( buildLayer                 via5b  1.1410    V   0.0000  0 )
...
techAddLayer T ( buildLayer          metal5a_diel  0.0418    D   4.2000  0 )
...
techAddLayer T ( buildLayer                 via5a  0.9192    V   0.0000  0 )
...
techAddLayer T ( buildLayer                metal6  0.7920    C   0.0000  0 )
...
techAddLayer T ( buildLayer           metal6_diel  0.4730    D   4.2000  0 )

techAddLayer T ( buildLayer          metal6_diel2  0.6600    D   7.0000  0 )
...
techAddLayer T ( buildLayer    active_metal4_diel  1.0310    D   4.2000  0 )

techAddLayer T ( buildLayer   active_metal5a_diel  0.0418    D   4.2000  0 )

techAddLayer T ( buildLayer       active_MIM_diel  0.9192    D   4.2000  0 )

techAddLayer T ( buildLayer    active_metal6_diel  0.4730    D   4.2000  0 )

techAddLayer T ( buildLayer   active_metal6_diel2  0.6600    D   7.0000  0 )
...
techAddLayer T ( buildLayer    sdcont_metal4_diel  1.0310    D   4.2000  0 )

techAddLayer T ( buildLayer   sdcont_metal5a_diel  0.0418    D   4.2000  0 )

techAddLayer T ( buildLayer       sdcont_MIM_diel  0.9192    D   4.2000  0 )

techAddLayer T ( buildLayer    sdcont_metal6_diel  0.4730    D   4.2000  0 )

techAddLayer T ( buildLayer   sdcont_metal6_diel2  0.6600    D   7.0000  0 )
...
techAddLayer T ( buildLayer  field_li_metal4_diel  1.0310    D   4.2000  0 )

techAddLayer T ( buildLayer field_li_metal5a_diel  0.0418    D   4.2000  0 )

techAddLayer T ( buildLayer     field_li_MIM_diel  0.9192    D   4.2000  0 )

techAddLayer T ( buildLayer  field_li_metal6_diel  0.4730    D   4.2000  0 )

techAddLayer T ( buildLayer field_li_metal6_diel2  0.6600    D   7.0000  0 )
