 ...
 if (!(isfuncdef techFindLayer)) {
    ...
    #
    T = (buildTechnology SmicSP10R_cal018_epm_sali_p2mt6_18335155_Cmax unconditional "ff" "2d" "mcs2d" "ph")
    techSetIndie T "ON"
...
techAddLayer T ( buildLayer                metal3  0.5280    C   0.0000  0 )
...
techAddLayer T ( buildLayer                    V3  0.6690    V   0.0000  0 )
...
techAddLayer T ( buildLayer           metal3_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer                metal4  0.5280    C   0.0000  0 )
...
techAddLayer T ( buildLayer                    V4  0.6690    V   0.0000  0 )
...
techAddLayer T ( buildLayer           metal4_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer               metal5a  0.5280    C   0.0000  0 )
...
techAddLayer T ( buildLayer                 via5b  0.7590    V   0.0000  0 )
...
techAddLayer T ( buildLayer          metal5a_diel  0.0342    D   4.2000  0 )
...
techAddLayer T ( buildLayer                 via5a  0.5048    V   0.0000  0 )
...
techAddLayer T ( buildLayer                metal6  0.9680    C   0.0000  0 )
...
techAddLayer T ( buildLayer           metal6_diel  0.0670    D   4.2000  0 )

techAddLayer T ( buildLayer          metal6_diel2  0.5400    D   7.0000  0 )
...
techAddLayer T ( buildLayer    active_metal3_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer    active_metal4_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer   active_metal5a_diel  0.0342    D   4.2000  0 )

techAddLayer T ( buildLayer       active_MIM_diel  0.5048    D   4.2000  0 )

techAddLayer T ( buildLayer    active_metal6_diel  0.0670    D   4.2000  0 )

techAddLayer T ( buildLayer   active_metal6_diel2  0.5400    D   7.0000  0 )
...
techAddLayer T ( buildLayer    sdcont_metal3_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer    sdcont_metal4_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer   sdcont_metal5a_diel  0.0342    D   4.2000  0 )

techAddLayer T ( buildLayer       sdcont_MIM_diel  0.5048    D   4.2000  0 )

techAddLayer T ( buildLayer    sdcont_metal6_diel  0.0670    D   4.2000  0 )

techAddLayer T ( buildLayer   sdcont_metal6_diel2  0.5400    D   7.0000  0 )
...
layerSetHeight T gtpoly_diel "" 0.283
...
techAddLayer T ( buildLayer  field_li_metal3_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer  field_li_metal4_diel  0.6690    D   4.2000  0 )

techAddLayer T ( buildLayer field_li_metal5a_diel  0.0342    D   4.2000  0 )

techAddLayer T ( buildLayer     field_li_MIM_diel  0.5048    D   4.2000  0 )

techAddLayer T ( buildLayer  field_li_metal6_diel  0.0670    D   4.2000  0 )

techAddLayer T ( buildLayer field_li_metal6_diel2  0.5400    D   7.0000  0 )
