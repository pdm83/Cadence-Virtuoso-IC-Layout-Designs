...
1. Update History:
   ...
   V1.2: In main document:
         ...
         In attachment:
         a. Added MIM SPICE Model in HSPICE format "e2r018_v1p2.lib", "e2r018_v1p2_mim.mdl" and macro model in the "e2r018_v1p2_res.ckt".
         ...
         d. Centered the model of N18E2R and P18E2R to match the PCM SPEC in "e2r018_v1p2.mdl".
         e. Revised the corner for N18E2R and P18E2R to match the PCM SPEC in "e2r018_v1p2.lib".
         f. Added 3T poly resistor model and centered the resistor model to match the PCM SPEC in "e2r018_v1p2_res.mdl", "e2r018_v1p2_res.ckt".
         g. Revised the corner for the resistor model to match the PCM SPEC in "e2r018_v1p2.lib".
   ...
   V1.5: In main document:
         ...
         Attachment files change description:
         a. Updated 1.8V N/PMOS HSPICE 1/f noise model to BSIM noise model and updated 1.8V N/PMOS model level to BSIM3V3.24 in 'e2r018_v1p5.mdl', 'e2r018_f_spe.mdl' and 'e2r018_v1p5_eldo.mdl'. 
...
2. Files:
      ...
      e2r018_v1p8_readme.txt          .... This file!
      e2r018_v1p8.lib                 .... Corner values for MOSFETs,resistors,PIP capacitor and BJT and MIM
      e2r018_v1p8.mdl                 .... Model parameters file for MOSFETs
      e2r018_v1p8_res.mdl             .... Model parameters file for resistors
      e2r018_v1p8_res.ckt             .... Resistor and Varactor and PIP and MIM macro model 
      e2r018_v1p8_pip.mdl	      .... PIP capacitor model 
      e2r018_v1p8_mim.mdl	      .... MIM capacitor model 
      e2r018_v1p8_bjt.mdl             .... Model parameters file for BJT
...
3. How to use SMIC SPICE models in HSPICE:
      ...
      a. Specify MOS, BJT, PIP and MIM model corner by the '.lib' statement;

         .lib '/xxx/xxx/e2r018_v1p8.lib' TT
                                         ^^ MOS model corner
         .lib '/xxx/xxx/e2r018_v1p8.lib' BJT_TT
                                             ^^ BJT model corner
         .lib '/xxx/xxx/e2r018_v1p8.lib' PIP_TT
                                             ^^ PIP model corner
         .lib '/xxx/xxx/e2r018_v1p8.lib' MIM_TT
                                             ^^ MIM model corner
              
      b. Include MOS, BJT, Diode, resistor, PIP and MIM model parameters by the '.include' statement;

         .include '/xxx/xxx/e2r018_v1p8.mdl'
  
         .include '/xxx/xxx/e2r018_v1p8_bjt.mdl'
         
         .include '/xxx/xxx/e2r018_v1p8_res.mdl'

         .include '/xxx/xxx/e2r018_v1p8_pip.mdl'

         .include '/xxx/xxx/e2r018_v1p8_mim.mdl'

       c. Call resistor macro model subcircuit by the following statement;
         
         .lib '/xxx/xxx/e2r018_v1p8.lib' TT
                                         ^^ MOS model corner
         .lib '/xxx/xxx/e2r018_v1p8.lib' RES_TT
                                             ^^ resistor model corner    
         .include '/xxx/xxx/e2r018_v1p8_res.ckt'
