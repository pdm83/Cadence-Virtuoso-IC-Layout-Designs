*** SMIC SPICE model for 0.18um EEPROM 1.8V/3.3V/5v/15.5v 2P6M process ***
*** For Spectre only ***
...
1. Update History:
   ...
   V1.2: In main document:
         ...
         In attachment:
         a. Added MIM SPICE Model in SPECTRE format "e2r018_v1p2_spe.lib","e2r018_v1p2_mim_spe.mdl" and macro model in the "e2r018_v1p2_res_spe.ckt".
         ...
         d. Centered the model of N18E2R and P18E2R to match the PCM SPEC in"e2r018_v1p2_spe.mdl".
         e. Revised the corner for N18E2R and P18E2R to match the PCM SPEC in"e2r018_v1p2_spe.lib".
         f. Added 3T poly resistor model and centered the resistor model to match the PCM SPEC in"e2r018_v1p2_res_spe.mdl","e2r018_v1p2_res_spe.ckt".
         g. Revised the corner for the resistor model to match the PCM SPEC in"e2r018_v1p2_spe.lib".
   ...
   V1.3: Main document file change description:
         ...
         d. Revise the wording of "res.def" to "res.va" in the file "e2r018_v1p3_res_spe.ckt".
...
2. Files:
      ...
      e2r018_v1p8_readme_spe.txt      .... This file!
      e2r018_v1p8_spe.mdl             .... Model parameters file for MOSFETs
      e2r018_v1p8_spe.scs             .... Corner values for MOSFETs,resistors, PIP capacitor and BJT and MIM capacitor
      e2r018_v1p8_res_spe.mdl	      .... Model parameters file for resistors
      e2r018_v1p8_res_spe.ckt         .... Resistor macro model
      res.va                          .... Resistor modules
      e2r018_v1p8_pip_spe.mdl	      .... PIP capacitor model
      e2r018_v1p8_mim_spe.mdl	      .... MIM capacitor model
      e2r018_v1p8_bjt_spe.mdl         .... Model parameters file for BJT
      e2r018_interconnect_struct_1.txt    .... Interconnect tables for structure-1 (Parallel lines above a bottom plate)
      e2r018_interconnect_struct_2.txt    .... Interconnect tables for structure-2 (Parallel lines between two plates)
...
3. How to use SMIC SPICE models in spectre:
      ...
      a. Specify mos, PIP and bjt and MIM model corner by the 'include' statement;

         include "/xxx/xxx/e2r018_v1p8_spe.scs" section=tt
                                                        ^^ mos model corner
         include "/xxx/xxx/e2r018_v1p8_spe.scs" section=bjt_tt
                                                            ^^ bjt model corner
         include "/xxx/xxx/e2r018_v1p8_spe.scs" section=pip_tt
						            ^^ pip model corner  
         include "/xxx/xxx/e2r018_v1p8_spe.scs" section=mim_tt
						            ^^ mim model corner  
      b. Include mos, diode, resistor, PIP and bjt and MIM model parameters by the 'include' statement;

         include "/xxx/xxx/e2r018_v1p8_spe.mdl"
  
         include "/xxx/xxx/e2r018_v1p8_res_spe.mdl"  
    
         include "/xxx/xxx/e2r018_v1p8_bjt_spe.mdl"
         
	 include "/xxx/xxx/e2r018_v1p8_pip_spe.mdl"

	 include "/xxx/xxx/e2r018_v1p8_mim_spe.mdl"

      c. Call resistor macro model subcircuit by the following statement;
         
         include "/xxx/xxx/e2r018_v1p8_spe.scs" section=tt
                                                        ^^ mos model corner
         include "/xxx/xxx/e2r018_v1p8_spe.scs" section=res_tt
                                                            ^^ resistor model corner    
         include "/xxx/xxx/e2r018_v1p8_res_spe.ckt"
	  ...
	  subcircuit condition you want to simulate. 
         ...
         Note: For metal resistor, don't need to use the subcircuit file 
               '/xxx/xxx/e2r018_v1p8_res_spe.ckt'.
