...
2. Files:
      ...
      l0065ll_io25_od33_readme.txt                  .... This file!
      l0065ll_io25_od33.lib                         .... Corner values for MOSFETs, diode,BJT and Resistor
      l0065ll_io25_od33.mdl                         .... Model parameters file for 1.2V/1.8V/2.5V(OD 3.3V) MOS
      l0065ll_io25_od33_bjt.mdl                     .... Model parameters file for 1.2V/1.8V/2.5V BJT
      l0065ll_io25_od33_dio.mdl                     .... Model parameters file for 1.2V/1.8V/2.5V diode
      l0065ll_io25_od33_res.mdl                     .... Model parameters file for 1.2V/1.8V/2.5V Resistor
      l0065ll_io25_od33_res.ckt                     .... Resistors macro model 
      l0065ll_io25_od33_var.ckt		            .... N+poly/NW MOS varactor macro model 
      l0065ll_io25_od33_mom.ckt		            .... MOM capacitor macro model 
...
3. How to use SMIC SPICE models in HSPICE:
      ...
      a. Specify MOS, diode and BJT model corner by the '.lib' statement;
         ...
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' TT
                                               ^^ mos model corner
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' DIO_TT
                                                   ^^ diode model corner
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' BJT_TT
                                                   ^^ BJT model corner   
      b. Specify MOS Monte Carlo model by the '.lib' statement;
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' MC
                                               ^^ mos Monte Carlo model 

      c. Include MOS, diode, BJT and resistor parameters by the '.include' statement;
         
         .include '/xxx/xxx/l0065ll_io25_od33.mdl'

         .include '/xxx/xxx/l0065ll_io25_od33_dio.mdl'

         .include '/xxx/xxx/l0065ll_io25_od33_bjt.mdl'
         
         .include '/xxx/xxx/l0065ll_io25_od33_res.mdl'  

      d. Call resistor macro model subcircuit by the following statement;
         
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' DIO_TT
                                                   ^^ diode model corner
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' RES_TT
                                                   ^^ resistor model corner
         .include '/xxx/xxx/l0065ll_io25_od33_res.ckt'
	 ...
	 subcircuit condition you want to simulate. 
         ...
         note: For metal resistor, don't need to use the subcircuit file 
               ...
               '/xxx/xxx/l0065ll_io25_od33_res.ckt'.       
      ...
      e. Call N+poly/NW MOS varactor model by the following statement;
         ...
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' VAR_TT
      ...
      f. Call MOM capacitor model by the following statement;
         ...
         .lib '/xxx/xxx/l0065ll_io25_od33.lib' MOM_TT
                                                   ^^ mom model corner
...
vd2 d2 0 1.2
vb b 0 0
m1 d1 g1 0 b n12ll w=10u l=0.06u
.dc  sweep  monte=500
.print dc  id1=i(vd1)
.end
---------------------------------------------------------------
